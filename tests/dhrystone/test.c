 ...
 *              - _printf, scanf (outside the measurement loop)
 ...
 *              "_printf"s are provided marking the points "Start Timer"
  ...
  /* Main and Proc_0 in the Ada version             */
{
 ...
 Number_Of_Runs = NUMBER_OF_RUNS;
  ...
  _printf ("Dhrystone Benchmark, Version %s\n", Version);

  Done = false;
  while (!Done) {

    _printf ("Trying %d runs through Dhrystone.\n", Number_Of_Runs);
  ...
  _printf ("Finished in %d ms\n", (int)User_Time);
  _printf("==================================================\n");
  _printf("Dhrystone %s         %d Marks\n", pass ? "PASS" : "FAIL",
      1030270 / (int)User_Time * NUMBER_OF_RUNS/ 500000);
  _printf("                   vs. 100000 Marks (i7-6700 @ 3.40GHz)\n");
